      ...
      <div className="w-[30rem] min-h-[7rem] px-5 pb-5 pt-10 bg-[#782443] rounded-xl ml-5 ring-offset-2 ring-4 ring-[#782443] relative">
        ...
        <div className="h-full grid gap-2 ">
          <h1 className="text-white font-semibold text-justify text-xl font-openSans">
            Selamat datang di tamakochi!Selamat datang di tamakochi!Selamat
            datang di tamakochi!Selamat datang di tamakochi!
          </h1>
          <div className="flex justify-end h-6" onClick={openPanel2}>
                ...
                <h1 className="text-white font-semibold text-justify text-xl font-openSans">
                  <Typewriter
                    ...
                    onInit={(typewriter) => {
                      typewriter
                        .typeString(
                          "Selamat datang di tamakochi!Selamat datang di tamakochi!Selamat datang di tamakochi!Selamat datang di tamakochi!Selamat datang di tamakochi!"
                        )
                        .start()
                        .pauseFor(300)
                        .callFunction(() => {
